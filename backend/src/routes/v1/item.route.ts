import { itemController, stockUpdateController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { itemValidation, stockUpdateValidation } from '../../validations/index.ts';
...
router
    ...
    .get(
        auth('getOwnItems'),
        validate(stockUpdateValidation.getItemStockUpdates),
        stockUpdateController.getItemStockUpdates
    );
