...
import { itemTools } from "../tools/item.tool.js";
import { stockUpdateTools } from "../tools/stock-update.tool.js";
...
export const mcpPostController = catchAsync(async (req, res) => {
    ...
    if (sessionId && transports[sessionId]) {
        ...
        registerMCPTools({ server, tools: [...userTools, ...itemTools, ...stockUpdateTools] });
